...
public class Vista {
    ...
    public void CrearFactura() {
        ...
        while (Op == 'S') {
            ...
            if (opcion == '1') {
                    ...
                    if (servicioRealizado == null) {
                        ...
                        if (Op2 == 'N') {
                            ...
                            if (tecnicoServicio == null) {
                                ...
                                tecnicoServicio.MostrarTecnico();
                ...
                ArrayList<Servicio> serviciosRealizados = new ArrayList();
                ArrayList<Tecnico> tecnicosRegistrados = new ArrayList();
                while (eleccion == 'S') {
                    String codigo = Entrada.leerString("Ingrese el codigo del servicio realizado al vehiculo: ");
                    ...
                    if (servAplicado == null) {
                        ...
                        System.out.println("Servicio=" + servAplicado.getNombreServicio());
                        do {
                            op2 = Entrada.leerChar("Desea añadirlo Si->'S' No->'N' ");
                        } while (op2 != 'S' && op2 != 'N');
                        if (op2 == 'S') {
                            if (serviciosRealizados.size() != 0) {
                                ...
                                if (tecnico == null) {
                                    ...
                                    if (tipoTecnico.equals("Tecnico monoServicio")) {
                                        ...
                                        if (tecn.getOficio().getCodigo().equals(servAplicado.getCodigo())) {
                                            ...
                                            if (encontro2 == true) {
                                                System.out.println("Error.... Ya el tecnico anteriormente habia sido registrado");
                                            } else {
                                        ...
                                        if (confirmar == true) {
                                            ...
                                            System.out.println("Nombre Tecnico: "+tecnic.getNombre()+"\n"+
                                                    "Especialidad: "+tecnic.getDetalle());
                ...
                if (serviciosRealizados.size()!= 0) {
                    ...
                    for (Servicio s1 : serviciosRealizados) {
                        //Sincronizacion
                        if (s1.getNombreServicio().equals("Sincronizacion")) {
                            s1.calcularCosto(noCilindro);
                        }

                        //Alineacion
                        if (s1.getNombreServicio().equals("Alineacion")) {
                            s1.calcularCosto(tVeh); 
                        }

                        //Balanceo 
                        if (s1.getNombreServicio().equals("Balanceo")) {
                            s1.calcularCosto(tamRing);
                        }

                        //Calibrar Valvulas
                        if (s1.getNombreServicio().equals("Calibrar Valvulas")) {
                            s1.calcularCosto(noCilindro);
                        }
                    }
                    System.out.println("\n");
    ...
    public void EliminarFactura() {
        if (this.logicaFactura.consultarFacturas().size() == 0) {
            ...
            while (OP == 'S') {
                int consecutivo = Entrada.leerInt("Ingrese el consecutivo de la factura a eliminar: ");
                ...
                if (facturaEliminar == null) {
                    ...
                    facturaEliminar.ImprimirFactura();
                    do {
                    ...
                    if (op == 'S') {
                     ...
                     do {
                        OP = Entrada.leerChar("Quiere eliminar otra factura Si->'S' No->'N': ");
                    } while (OP != 'S' && OP != 'N');
                }
            }
        }
        ...
        if (this.logicaTecnico.consultarTecnico().size() == 0) {
            ...
            while (OP == 'S') {
                ...
                if (tecnicoPagar == null) {
                    ...
                    do{
                        OP=Entrada.leerChar("Desea Consultar otra nomina Si->'S' NO->'N': ");
                    }while(OP!='S' && OP!='N');
                }
